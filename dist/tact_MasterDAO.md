...
graph TD
MasterDAO
MasterDAO --> ContractCitizenDAOv1
MasterDAO --> ContractDAOv2
ContractDAOv2 --> GovernanceJettonMinter
GovernanceJettonMinter --> JettonWalletGovernance
ContractDAOv2 --> ContractCitizenDAOv1
ContractDAOv2 --> ContractVirtualDAOv2
ContractDAOv2 --> ContractVaultDAOv1
ContractDAOv2 --> JettonWalletGovernance
MasterDAO --> ContractDAOv1
ContractDAOv1 --> GovernanceJettonMinter
ContractDAOv1 --> ContractJettonDAOv1
ContractDAOv1 --> ContractVaultDAOv1
ContractDAOv1 --> JettonWalletGovernance
MasterDAO --> GovernanceJettonMinter
MasterDAO --> JettonWalletGovernance
MasterDAO --> ContractVirtualDAOv2
MasterDAO --> ContractVaultDAOv1
MasterDAO --> ContractJettonDAOv1
```