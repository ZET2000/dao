...
export function dictValueParserMasterDAO$Data(): DictionaryValue<MasterDAO$Data> {
 ...
 type JettonWalletGovernance_init_args = {
    $$type: 'JettonWalletGovernance_init_args';
    status: bigint;
    balance: bigint;
    owner: Address;
...
function initJettonWalletGovernance_init_args(src: JettonWalletGovernance_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(src.status, 4);
        b_0.storeCoins(src.balance);
...
async function JettonWalletGovernance_init(status: bigint, balance: bigint, owner: Address, master: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    initJettonWalletGovernance_init_args({ $$type: 'JettonWalletGovernance_init_args', status, balance, owner, master })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const JettonWalletGovernance_errors = {
...
export const JettonWalletGovernance_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const JettonWalletGovernance_types: ABIType[] = [
...
const JettonWalletGovernance_opcodes = {
    "Deploy": 2490013878,
    "DeployOk": 2952335191,
...
const JettonWalletGovernance_getters: ABIGetter[] = [
...
export const JettonWalletGovernance_getterMapping: { [key: string]: string } = {
    'get_wallet_data': 'getGetWalletData',
    'get_status': 'getGetStatus',
}

const JettonWalletGovernance_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"typed","type":"SetStatus"}},
...
export class JettonWalletGovernance implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = JettonWalletGovernance_errors_backward;
    public static readonly opcodes = JettonWalletGovernance_opcodes;
    
    static async init(status: bigint, balance: bigint, owner: Address, master: Address) {
        return await JettonWalletGovernance_init(status, balance, owner, master);
    }
    
    static async fromInit(status: bigint, balance: bigint, owner: Address, master: Address) {
        const __gen_init = await JettonWalletGovernance_init(status, balance, owner, master);
        const address = contractAddress(0, __gen_init);
        return new JettonWalletGovernance(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new JettonWalletGovernance(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  JettonWalletGovernance_types,
        getters: JettonWalletGovernance_getters,
        receivers: JettonWalletGovernance_receivers,
        errors: JettonWalletGovernance_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: JettonTransfer | JettonTransferInternal | JettonBurn | SetStatus | TopUp) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetStatus') {
            body = beginCell().store(storeSetStatus(message)).endCell();
        }
