...
export function dictValueParserMasterDAO$Data(): DictionaryValue<MasterDAO$Data> {
 ...
 type ContractCitizenDAOv1_init_args = {
    $$type: 'ContractCitizenDAOv1_init_args';
    owner: Address;
    admin: Address | null;
    status: bigint;
...
function initContractCitizenDAOv1_init_args(src: ContractCitizenDAOv1_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.admin);
...
async function ContractCitizenDAOv1_init(owner: Address, admin: Address | null, status: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    initContractCitizenDAOv1_init_args({ $$type: 'ContractCitizenDAOv1_init_args', owner, admin, status })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const ContractCitizenDAOv1_errors = {
...
export const ContractCitizenDAOv1_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const ContractCitizenDAOv1_types: ABIType[] = [
...
const ContractCitizenDAOv1_opcodes = {
    "Deploy": 2490013878,
    "DeployOk": 2952335191,
...
export class ContractCitizenDAOv1 implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = ContractCitizenDAOv1_errors_backward;
    public static readonly opcodes = ContractCitizenDAOv1_opcodes;
    
    static async init(owner: Address, admin: Address | null, status: bigint) {
        return await ContractCitizenDAOv1_init(owner, admin, status);
    }
    
    static async fromInit(owner: Address, admin: Address | null, status: bigint) {
        const __gen_init = await ContractCitizenDAOv1_init(owner, admin, status);
        const address = contractAddress(0, __gen_init);
        return new ContractCitizenDAOv1(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new ContractCitizenDAOv1(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ContractCitizenDAOv1_types,
        getters: ContractCitizenDAOv1_getters,
        receivers: ContractCitizenDAOv1_receivers,
        errors: ContractCitizenDAOv1_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: "init" | PassPassport | ProvideAction | ChangeAdminCitizen) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ProvideAction') {
            body = beginCell().store(storeProvideAction(message)).endCell();
        }
