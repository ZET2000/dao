...
async function NFTItem_init(owner: Address | null, content: Cell | null, editor: Address, collectionAddress: Address, itemIndex: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    initNFTItem_init_args({ $$type: 'NFTItem_init_args', owner, content, editor, collectionAddress, itemIndex })(builder);
...
export class NFTItem implements Contract {
    ...
    static async init(owner: Address | null, content: Cell | null, editor: Address, collectionAddress: Address, itemIndex: bigint) {
        return await NFTItem_init(owner, content, editor, collectionAddress, itemIndex);
    }
    
    static async fromInit(owner: Address | null, content: Cell | null, editor: Address, collectionAddress: Address, itemIndex: bigint) {
        const __gen_init = await NFTItem_init(owner, content, editor, collectionAddress, itemIndex);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | GetStaticData | Slice | EditContent | Transfer) {
