...
export function dictValueParserMasterDAO$Data(): DictionaryValue<MasterDAO$Data> {
 ...
 type ContractVirtualDAOv2_init_args = {
    $$type: 'ContractVirtualDAOv2_init_args';
    owner: Address;
    admin: Address;
    option: Address | null;
...
function initContractVirtualDAOv2_init_args(src: ContractVirtualDAOv2_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.admin);
...
async function ContractVirtualDAOv2_init(owner: Address, admin: Address, option: Address | null, status: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    initContractVirtualDAOv2_init_args({ $$type: 'ContractVirtualDAOv2_init_args', owner, admin, option, status })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const ContractVirtualDAOv2_errors = {
...
export const ContractVirtualDAOv2_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const ContractVirtualDAOv2_types: ABIType[] = [
...
const ContractVirtualDAOv2_opcodes = {
    "Deploy": 2490013878,
    "DeployOk": 2952335191,
...
const ContractVirtualDAOv2_getters: ABIGetter[] = [
    {"name":"get_option","methodId":105348,"arguments":[],"returnType":{"kind":"simple","type":"address","optional":true}},
]

export const ContractVirtualDAOv2_getterMapping: { [key: string]: string } = {
    'get_option': 'getGetOption',
}

const ContractVirtualDAOv2_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"VirtualInitialization"}},
    {"receiver":"internal","message":{"kind":"text","text":"-"}},
]
...
export class ContractVirtualDAOv2 implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = ContractVirtualDAOv2_errors_backward;
    public static readonly opcodes = ContractVirtualDAOv2_opcodes;
    
    static async init(owner: Address, admin: Address, option: Address | null, status: bigint) {
        return await ContractVirtualDAOv2_init(owner, admin, option, status);
    }
    
    static async fromInit(owner: Address, admin: Address, option: Address | null, status: bigint) {
        const __gen_init = await ContractVirtualDAOv2_init(owner, admin, option, status);
        const address = contractAddress(0, __gen_init);
        return new ContractVirtualDAOv2(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new ContractVirtualDAOv2(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ContractVirtualDAOv2_types,
        getters: ContractVirtualDAOv2_getters,
        receivers: ContractVirtualDAOv2_receivers,
        errors: ContractVirtualDAOv2_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: VirtualInitialization | "-") {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'VirtualInitialization') {
            body = beginCell().store(storeVirtualInitialization(message)).endCell();
        }
        if (message === "-") {
